...
EnemyFactory::EnemyFactory(AssetManager& assetManager) {
    enemyDatabase[Alginnus] = Enemy("Alginnus", assetManager.getTexture("Alginnus"), 10, 88, 88, 160, 88, 88);
    enemyDatabase[Cavalier] = Enemy("Cavalier", assetManager.getTexture("Cavalier"), 10, 88, 88, 160, 88, 88);
    enemyDatabase[Cheerot] = Enemy("Cheerot", assetManager.getTexture("Cheerot"), 10, 88, 88, 160, 88, 88);
    enemyDatabase[Golorch] = Enemy("Golorch", assetManager.getTexture("Golorch"), 10, 88, 88, 160, 88, 88);
    enemyDatabase[Khafiyn] = Enemy("Khafiyn", assetManager.getTexture("Khafiyn"), 10, 88, 88, 160, 88, 88);
    enemyDatabase[LakeDowager] = Enemy("LakeDowager", assetManager.getTexture("LakeDowager"), 10, 88, 88, 160, 88, 88);
    enemyDatabase[Luminant] = Enemy("Luminant", assetManager.getTexture("Luminant"), 10, 88, 88, 160, 88, 88);
